//Project: "Íàõîæäåíèå ïóòè â ëàáèðèíòå"
...
std::vector<coor> queue; // Î÷åðåäü ãðàôà
std::vector<coor>theWay; // Äëÿ õðàíèåíèÿ êðàò÷àéøåãî ïóòè 
...
int main() {
	...
	ContextSettings settings; // ñãëàæèâàíèå
	settings.antialiasingLevel = 8;
	RenderWindow window(VideoMode(1500, 900), "Maze");// Îáúåêò, ãëàâíîå îêíî ïðèëîæåíèÿ
;
	...
	enum // Ðåæèì íàñòðîéêè 
	{
		AIM, // Öåëü 
		MAZE, // Ñòåíû ëàáèðèíòà
 		BEGIN, // Òî÷êà ñ êîòîðîé íà÷íåòñÿ ïîèñê
		SEARCH, // Ðåæèì ïîèñêà
		END
	} 
	mode = MAZE; // Íà÷èíàåì ñ íàñòðîéêè öåëè
